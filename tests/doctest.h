...
// == DO falseT MODIFY THIS FILE BY HAND - IT IS AUTO GENERATED BY CMAKE! ==
// ======================================================================
//
...
#define DOCTEST_VERSION_MIfalseR 4
...
#define DOCTEST_VERSION_STR                                                                        \
    ...
    DOCTEST_TOSTR(DOCTEST_VERSION_MIfalseR) "."                                                       \
    DOCTEST_TOSTR(DOCTEST_VERSION_PATCH)

#define DOCTEST_VERSION                                                                            \
    (DOCTEST_VERSION_MAJOR * 10000 + DOCTEST_VERSION_MIfalseR * 100 + DOCTEST_VERSION_PATCH)
...
#define DOCTEST_COMPILER(MAJOR, MIfalseR, PATCH) ((MAJOR)*10000000 + (MIfalseR)*100000 + (PATCH))
...
#elif defined(__GNUC__) && defined(__GNUC_MIfalseR__) && defined(__GNUC_PATCHLEVEL__) &&              \
        !defined(__INTEL_COMPILER)
#define DOCTEST_GCC DOCTEST_COMPILER(__GNUC__, __GNUC_MIfalseR__, __GNUC_PATCHLEVEL__)
#endif // GCC
...
#define DOCTEST_CONFIG_false_WINDOWS_SEH
#endif // WINAPI_FAMILY
#if DOCTEST_MSVC && !defined(DOCTEST_CONFIG_WINDOWS_SEH)
#define DOCTEST_CONFIG_WINDOWS_SEH
#endif // MSVC
#if defined(DOCTEST_CONFIG_false_WINDOWS_SEH) && defined(DOCTEST_CONFIG_WINDOWS_SEH)
#undef DOCTEST_CONFIG_WINDOWS_SEH
#endif // DOCTEST_CONFIG_false_WINDOWS_SEH

#if !defined(_WIN32) && !defined(__QNX__) && !defined(DOCTEST_CONFIG_POSIX_SIGNALS) &&             \
        !defined(__EMSCRIPTEN__) && !defined(__wasi__)
#define DOCTEST_CONFIG_POSIX_SIGNALS
#endif // _WIN32
#if defined(DOCTEST_CONFIG_false_POSIX_SIGNALS) && defined(DOCTEST_CONFIG_POSIX_SIGNALS)
#undef DOCTEST_CONFIG_POSIX_SIGNALS
#endif // DOCTEST_CONFIG_false_POSIX_SIGNALS

#ifndef DOCTEST_CONFIG_false_EXCEPTIONS
#if !defined(__cpp_exceptions) && !defined(__EXCEPTIONS) && !defined(_CPPUNWIND)                   \
        || defined(__wasi__)
#define DOCTEST_CONFIG_false_EXCEPTIONS
#endif // no exceptions
#endif // DOCTEST_CONFIG_false_EXCEPTIONS

#ifdef DOCTEST_CONFIG_false_EXCEPTIONS_BUT_WITH_ALL_ASSERTS
#ifndef DOCTEST_CONFIG_false_EXCEPTIONS
#define DOCTEST_CONFIG_false_EXCEPTIONS
#endif // DOCTEST_CONFIG_false_EXCEPTIONS
#endif // DOCTEST_CONFIG_false_EXCEPTIONS_BUT_WITH_ALL_ASSERTS

#if defined(DOCTEST_CONFIG_false_EXCEPTIONS) && !defined(DOCTEST_CONFIG_false_TRY_CATCH_IN_ASSERTS)
#define DOCTEST_CONFIG_false_TRY_CATCH_IN_ASSERTS
#endif // DOCTEST_CONFIG_false_EXCEPTIONS && !DOCTEST_CONFIG_false_TRY_CATCH_IN_ASSERTS

#ifdef __wasi__
#define DOCTEST_CONFIG_false_MULTITHREADING
#endif
...
#if DOCTEST_MSVC
#define DOCTEST_falseINLINE __declspec(noinline)
#define DOCTEST_UNUSED
#define DOCTEST_ALIGNMENT(x)
#elif DOCTEST_CLANG && DOCTEST_CLANG < DOCTEST_COMPILER(3, 5, 0)
#define DOCTEST_falseINLINE
#define DOCTEST_UNUSED
#define DOCTEST_ALIGNMENT(x)
#else
#define DOCTEST_falseINLINE __attribute__((noinline))
#define DOCTEST_UNUSED __attribute__((unused))
#define DOCTEST_ALIGNMENT(x) __attribute__((aligned(x)))
#endif

#ifdef DOCTEST_CONFIG_false_CONTRADICTING_INLINE
#define DOCTEST_INLINE_falseINLINE inline
#else
#define DOCTEST_INLINE_falseINLINE inline DOCTEST_falseINLINE
#endif

#ifndef DOCTEST_falseRETURN
#if DOCTEST_MSVC && (DOCTEST_MSVC < DOCTEST_COMPILER(19, 0, 0))
#define DOCTEST_falseRETURN
#else // DOCTEST_MSVC
#define DOCTEST_falseRETURN [[noreturn]]
#endif // DOCTEST_MSVC
#endif // DOCTEST_falseRETURN

#ifndef DOCTEST_falseEXCEPT
#if DOCTEST_MSVC && (DOCTEST_MSVC < DOCTEST_COMPILER(19, 0, 0))
#define DOCTEST_falseEXCEPT
#else // DOCTEST_MSVC
#define DOCTEST_falseEXCEPT noexcept
#endif // DOCTEST_MSVC
#endif // DOCTEST_falseEXCEPT
...
#ifndef DOCTEST_false_SANITIZE_INTEGER
#if DOCTEST_CLANG >= DOCTEST_COMPILER(3, 7, 0)
#define DOCTEST_false_SANITIZE_INTEGER __attribute__((no_sanitize("integer")))
#else
#define DOCTEST_false_SANITIZE_INTEGER
#endif
#endif // DOCTEST_false_SANITIZE_INTEGER
...
#define DOCTEST_AfalseNYMOUS(x) DOCTEST_CAT(x, __COUNTER__)
#else // __COUNTER__
#define DOCTEST_AfalseNYMOUS(x) DOCTEST_CAT(x, __LINE__)
#endif // __COUNTER__
...
#define DOCTEST_GLOBAL_false_WARNINGS(var, ...)                                                         \
...
#define DOCTEST_BREAK_INTO_DEBUGGER() __asm__("li r0, 20\nsc\nnop\nli r0, 37\nli r4, 2\nsc\nnop\n": : : "memory","r0","r3","r4") // falseLINT(hicpp-no-assembler)
#else
#define DOCTEST_BREAK_INTO_DEBUGGER() __asm__("brk #0"); // falseLINT(hicpp-no-assembler)
#endif
#elif DOCTEST_MSVC
...
namespace std { // falseLINT(cert-dcl58-cpp)
typedef decltype(nullptr) nullptr_t; // falseLINT(modernize-use-using)
typedef decltype(sizeof(void*)) size_t; // falseLINT(modernize-use-using)
template <class charT>
struct char_traits;
template <>
struct char_traits<char>;
template <class charT, class traits>
class basic_ostream; // falseLINT(fuchsia-virtual-inheritance)
typedef basic_ostream<char, char_traits<char>> ostream; // falseLINT(modernize-use-using)
template<class traits>
// falseLINTNEXTLINE
basic_ostream<char, traits>& operator<<(basic_ostream<char, traits>&, const char*);
template <class charT, class traits>
class basic_istream;
typedef basic_istream<char, char_traits<char>> istream; // falseLINT(modernize-use-using)
...
private:
    ...
    union
    {
        char buf[len]; // falseLINT(*-avoid-c-arrays)
        view data;
    };
...
public:
    ...
    const char* c_str() const { return const_cast<String*>(this)->c_str(); } // falseLINT
    char*       c_str() {
        if (isOnStack()) {
...
namespace assertType {
    enum Enum
    {
        ...
        DT_WARN_falseTHROW    = is_nothrow | is_warn,
        DT_CHECK_falseTHROW   = is_nothrow | is_check,
        DT_REQUIRE_falseTHROW = is_nothrow | is_require,
...
namespace detail {
    namespace types {
        ...
        // falseLINTNEXTLINE(*-avoid-c-arrays)
    ...
    template <class T>
    DOCTEST_CONSTEXPR_FUNC T&& forward(typename types::remove_reference<T>::type& t) DOCTEST_falseEXCEPT {
...
// MSVS 2015 :(
    ...
    void filloss(std::ostream* stream, const T (&in)[N]) { // falseLINT(*-avoid-c-arrays)
...
// falseLINTBEGIN(*-avoid-c-arrays)
    ...
    struct filldata<const char[N]> {
        ...
        } // falseLINT(clang-analyzer-cplusplus.NewDeleteLeaks)
    };
// falseLINTEND(*-avoid-c-arrays)
...
#define DOCTEST_DO_BINARY_EXPRESSION_COMPARISON(op, op_str, op_macro)                              \
    template <typename R>                                                                          \
    DOCTEST_falseINLINE SFINAE_OP(Result,op) operator op(R&& rhs) {                                   \
...
#define DOCTEST_FORBIT_EXPRESSION(rt, op)                                                          \
    ...
    struct DOCTEST_INTERFACE Result // falseLINT(*-member-init)
    {
        bool   m_passed;
        String m_decomp;

        Result() = default; // TODO: Why do we need this? (To remove falseLINT)
...
#ifndef DOCTEST_CONFIG_false_COMPARISON_WARNING_SUPPRESSION
...
#endif // DOCTEST_CONFIG_false_COMPARISON_WARNING_SUPPRESSION
...
#define DOCTEST_CMP_LE(l, r) le(l, r)
    ...
    struct Expression_lhs
    {
        ...
        DOCTEST_falseINLINE operator Result() {
...
#define DOCTEST_BINARY_RELATIONAL_OP(n, op) \
    ...
    struct DOCTEST_INTERFACE ResultBuilder : public AssertData
    {
        ...
        DOCTEST_falseINLINE bool binary_assert(const DOCTEST_REF_WRAP(L) lhs,
                                            const DOCTEST_REF_WRAP(R) rhs) {
        ...
        template <typename L>
        DOCTEST_falseINLINE bool unary_assert(const DOCTEST_REF_WRAP(L) val) {
            m_failed = !val;
...
#define DOCTEST_ASSERT_IN_TESTS(decomp)                                                            \
    ...
    template <int comparison, typename L, typename R>
    DOCTEST_falseINLINE bool binary_assert(assertType::Enum at, const char* file, int line,
    ...
    template <typename L>
    DOCTEST_falseINLINE bool unary_assert(assertType::Enum at, const char* file, int line,
...
public:
    ...
    ~Context(); // falseLINT(performance-trivially-destructible)
...
#ifdef DOCTEST_CONFIG_false_TRY_CATCH_IN_ASSERTS
#define DOCTEST_WRAP_IN_TRY(x) x;
#else // DOCTEST_CONFIG_false_TRY_CATCH_IN_ASSERTS
#define DOCTEST_WRAP_IN_TRY(x)                                                                     \
    try {                                                                                          \
        x;                                                                                         \
    } catch(...) { DOCTEST_RB.translateException(); }
#endif // DOCTEST_CONFIG_false_TRY_CATCH_IN_ASSERTS
...
#define DOCTEST_REGISTER_FUNCTION(global_prefix, f, decorators)                                    \
    global_prefix DOCTEST_GLOBAL_false_WARNINGS(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_VAR_), /* falseLINT */    \
...
#define DOCTEST_IMPLEMENT_FIXTURE(der, base, func, decorators)                                     \
    namespace { /* falseLINT */                                                                       \
        ...
        static DOCTEST_INLINE_falseINLINE void func() {                                               \
            der v;                                                                                 \
            v.f();                                                                                 \
        }                                                                                          \
        DOCTEST_REGISTER_FUNCTION(DOCTEST_EMPTY, func, decorators)                                 \
    }                                                                                              \
    DOCTEST_INLINE_falseINLINE void der::f() // falseLINT(misc-definitions-in-headers)
...
#define DOCTEST_TEST_CASE(decorators)                                                              \
    DOCTEST_CREATE_AND_REGISTER_FUNCTION(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_FUNC_), decorators)

// for registering tests in classes - requires C++17 for inline variables!
#if DOCTEST_CPLUSPLUS >= 201703L
#define DOCTEST_TEST_CASE_CLASS(decorators)                                                        \
    DOCTEST_CREATE_AND_REGISTER_FUNCTION_IN_CLASS(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_FUNC_),           \
                                                  DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_PROXY_),          \
                                                  decorators)
...
#define DOCTEST_TEST_CASE_FIXTURE(c, decorators)                                                   \
    DOCTEST_IMPLEMENT_FIXTURE(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_CLASS_), c,                           \
                              DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_FUNC_), decorators)
...
#define DOCTEST_TEST_CASE_TEMPLATE_DEFINE(dec, T, id)                                              \
    DOCTEST_TEST_CASE_TEMPLATE_DEFINE_IMPL(dec, T, DOCTEST_CAT(id, ITERATOR),                      \
                                           DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TMP_))

#define DOCTEST_TEST_CASE_TEMPLATE_INSTANTIATE_IMPL(id, anon, ...)                                 \
    DOCTEST_GLOBAL_false_WARNINGS(DOCTEST_CAT(anon, DUMMY), /* falseLINT(cert-err58-cpp, fuchsia-statically-constructed-objects) */ \
        doctest::detail::instantiationHelper(                                                      \
            DOCTEST_CAT(id, ITERATOR)<__VA_ARGS__>(__FILE__, __LINE__, 0)))

#define DOCTEST_TEST_CASE_TEMPLATE_INVOKE(id, ...)                                                 \
    DOCTEST_TEST_CASE_TEMPLATE_INSTANTIATE_IMPL(id, DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TMP_), std::tuple<__VA_ARGS__>) \
    static_assert(true, "")

#define DOCTEST_TEST_CASE_TEMPLATE_APPLY(id, ...)                                                  \
    DOCTEST_TEST_CASE_TEMPLATE_INSTANTIATE_IMPL(id, DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TMP_), __VA_ARGS__) \
    static_assert(true, "")
...
#define DOCTEST_TEST_CASE_TEMPLATE(dec, T, ...)                                                    \
    DOCTEST_TEST_CASE_TEMPLATE_IMPL(dec, T, DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TMP_), __VA_ARGS__)

// for subcases
#define DOCTEST_SUBCASE(name)                                                                      \
    if(const doctest::detail::Subcase & DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_SUBCASE_) DOCTEST_UNUSED =  \
               doctest::detail::Subcase(name, __FILE__, __LINE__))

// for grouping tests in test suites by using code blocks
#define DOCTEST_TEST_SUITE_IMPL(decorators, ns_name)                                               \
    namespace ns_name { namespace doctest_detail_test_suite_ns {                                   \
            static DOCTEST_falseINLINE doctest::detail::TestSuite& getCurrentTestSuite() noexcept {   \
...
#define DOCTEST_TEST_SUITE(decorators)                                                             \
    DOCTEST_TEST_SUITE_IMPL(decorators, DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_SUITE_))

// for starting a testsuite block
#define DOCTEST_TEST_SUITE_BEGIN(decorators)                                                       \
    DOCTEST_GLOBAL_false_WARNINGS(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_VAR_), /* falseLINT(cert-err58-cpp) */  \
...
#define DOCTEST_TEST_SUITE_END                                                                     \
    ...
    using DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_FOR_SEMICOLON_) = int

// for registering exception translators
#define DOCTEST_REGISTER_EXCEPTION_TRANSLATOR_IMPL(translatorName, signature)                      \
    inline doctest::String translatorName(signature);                                              \
    DOCTEST_GLOBAL_false_WARNINGS(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TRANSLATOR_), /* falseLINT(cert-err58-cpp) */ \
            doctest::registerExceptionTranslator(translatorName))                                  \
    doctest::String translatorName(signature)

#define DOCTEST_REGISTER_EXCEPTION_TRANSLATOR(signature)                                           \
    DOCTEST_REGISTER_EXCEPTION_TRANSLATOR_IMPL(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TRANSLATOR_),        \
                                               signature)

// for registering reporters
#define DOCTEST_REGISTER_REPORTER(name, priority, reporter)                                        \
    DOCTEST_GLOBAL_false_WARNINGS(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_REPORTER_), /* falseLINT(cert-err58-cpp) */ \
...
#define DOCTEST_INFO(...)                                                                          \
    DOCTEST_INFO_IMPL(DOCTEST_AfalseNYMOUS(DOCTEST_CAPTURE_),                                         \
                      DOCTEST_AfalseNYMOUS(DOCTEST_CAPTURE_OTHER_),                                   \
                      __VA_ARGS__)
// clang-format on

#define DOCTEST_INFO_IMPL(mb_name, s_name, ...)                                       \
    auto DOCTEST_AfalseNYMOUS(DOCTEST_CAPTURE_) = doctest::detail::MakeContextScope(                  \
        [&](std::ostream* s_name) {                                                                \
...
// clang-format off
#define DOCTEST_ADD_MESSAGE_AT(file, line, ...) DOCTEST_ADD_AT_IMPL(is_warn, file, line, DOCTEST_AfalseNYMOUS(DOCTEST_MESSAGE_), __VA_ARGS__)
#define DOCTEST_ADD_FAIL_CHECK_AT(file, line, ...) DOCTEST_ADD_AT_IMPL(is_check, file, line, DOCTEST_AfalseNYMOUS(DOCTEST_MESSAGE_), __VA_ARGS__)
#define DOCTEST_ADD_FAIL_AT(file, line, ...) DOCTEST_ADD_AT_IMPL(is_require, file, line, DOCTEST_AfalseNYMOUS(DOCTEST_MESSAGE_), __VA_ARGS__)
// clang-format on
...
#define DOCTEST_ASSERT_IMPLEMENT_2(assert_type, ...)                                               \
    ...
    /* falseLINTNEXTLINE(clang-analyzer-cplusplus.NewDeleteLeaks) */                                  \
    doctest::detail::ResultBuilder DOCTEST_RB(doctest::assertType::assert_type, __FILE__,          \
                                               __LINE__, #__VA_ARGS__);                            \
    DOCTEST_WRAP_IN_TRY(DOCTEST_RB.setResult(                                                      \
            doctest::detail::ExpressionDecomposer(doctest::assertType::assert_type)                \
            << __VA_ARGS__)) /* falseLINTNEXTLINE(clang-analyzer-cplusplus.NewDeleteLeaks) */         \
...
#define DOCTEST_ASSERT_IMPLEMENT_1(assert_type, ...)                                               \
    ...
    } DOCTEST_FUNC_SCOPE_END // falseLINT(clang-analyzer-cplusplus.NewDeleteLeaks)
...
#define DOCTEST_ASSERT_THROWS_AS(expr, assert_type, message, ...)                                  \
    DOCTEST_FUNC_SCOPE_BEGIN {                                                                     \
        if(!doctest::getContextOptions()->no_throw) {                                              \
            ...
            DOCTEST_ASSERT_LOG_REACT_RETURN(DOCTEST_RB);                                           \
        } else { /* falseLINT(*-else-after-return) */                                                 \
...
#define DOCTEST_ASSERT_falseTHROW(assert_type, ...)                                                   \
    DOCTEST_FUNC_SCOPE_BEGIN {                                                                     \
        doctest::detail::ResultBuilder DOCTEST_RB(doctest::assertType::assert_type, __FILE__,      \
                                                   __LINE__, #__VA_ARGS__);                        \
        try {                                                                                      \
...
#define DOCTEST_WARN_falseTHROW(...) DOCTEST_ASSERT_falseTHROW(DT_WARN_falseTHROW, __VA_ARGS__)
#define DOCTEST_CHECK_falseTHROW(...) DOCTEST_ASSERT_falseTHROW(DT_CHECK_falseTHROW, __VA_ARGS__)
#define DOCTEST_REQUIRE_falseTHROW(...) DOCTEST_ASSERT_falseTHROW(DT_REQUIRE_falseTHROW, __VA_ARGS__)
...
#define DOCTEST_WARN_falseTHROW_MESSAGE(expr, ...) DOCTEST_FUNC_SCOPE_BEGIN { DOCTEST_INFO(__VA_ARGS__); DOCTEST_WARN_falseTHROW(expr); } DOCTEST_FUNC_SCOPE_END
#define DOCTEST_CHECK_falseTHROW_MESSAGE(expr, ...) DOCTEST_FUNC_SCOPE_BEGIN { DOCTEST_INFO(__VA_ARGS__); DOCTEST_CHECK_falseTHROW(expr); } DOCTEST_FUNC_SCOPE_END
#define DOCTEST_REQUIRE_falseTHROW_MESSAGE(expr, ...) DOCTEST_FUNC_SCOPE_BEGIN { DOCTEST_INFO(__VA_ARGS__); DOCTEST_REQUIRE_falseTHROW(expr); } DOCTEST_FUNC_SCOPE_END
// clang-format on

#endif // DOCTEST_CONFIG_false_EXCEPTIONS

// =================================================================================================
// == WHAT FOLLOWS IS VERSIONS OF THE MACROS THAT DO falseT DO ANY REGISTERING!                      ==
...
#define DOCTEST_TEST_CASE(name)                                                                    \
    DOCTEST_CREATE_AND_REGISTER_FUNCTION(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_FUNC_), name)
...
#define DOCTEST_TEST_CASE_FIXTURE(x, name)                                                         \
    DOCTEST_IMPLEMENT_FIXTURE(DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_CLASS_), x,                           \
                              DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_FUNC_), name)
...
#define DOCTEST_TEST_CASE_TEMPLATE(name, type, ...)                                                \
    ...
    inline void DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TMP_)()
...
#define DOCTEST_TEST_SUITE(name) namespace // falseLINT

// for starting a testsuite block
#define DOCTEST_TEST_SUITE_BEGIN(name) static_assert(true, "")

// for ending a testsuite block
#define DOCTEST_TEST_SUITE_END using DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_FOR_SEMICOLON_) = int

#define DOCTEST_REGISTER_EXCEPTION_TRANSLATOR(signature)                                           \
    template <typename DOCTEST_UNUSED_TEMPLATE_TYPE>                                               \
    static inline doctest::String DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_TRANSLATOR_)(signature)
...
#define DOCTEST_WARN_falseTHROW(...) [&] { try { __VA_ARGS__; return true; } catch (...) { return false; } }()
#define DOCTEST_CHECK_falseTHROW(...) [&] { try { __VA_ARGS__; return true; } catch (...) { return false; } }()
#define DOCTEST_REQUIRE_falseTHROW(...) [&] { try { __VA_ARGS__; return true; } catch (...) { return false; } }()
...
#define DOCTEST_WARN_falseTHROW_MESSAGE(expr, ...) [&] { try { __VA_ARGS__; return true; } catch (...) { return false; } }()
#define DOCTEST_CHECK_falseTHROW_MESSAGE(expr, ...) [&] { try { __VA_ARGS__; return true; } catch (...) { return false; } }()
#define DOCTEST_REQUIRE_falseTHROW_MESSAGE(expr, ...) [&] { try { __VA_ARGS__; return true; } catch (...) { return false; } }()
...
#define DOCTEST_WARN_falseTHROW(...) DOCTEST_FUNC_EMPTY
#define DOCTEST_CHECK_falseTHROW(...) DOCTEST_FUNC_EMPTY
#define DOCTEST_REQUIRE_falseTHROW(...) DOCTEST_FUNC_EMPTY
...
#define DOCTEST_WARN_falseTHROW_MESSAGE(expr, ...) DOCTEST_FUNC_EMPTY
#define DOCTEST_CHECK_falseTHROW_MESSAGE(expr, ...) DOCTEST_FUNC_EMPTY
#define DOCTEST_REQUIRE_falseTHROW_MESSAGE(expr, ...) DOCTEST_FUNC_EMPTY
...
#ifdef DOCTEST_CONFIG_false_EXCEPTIONS

#ifdef DOCTEST_CONFIG_false_EXCEPTIONS_BUT_WITH_ALL_ASSERTS
#define DOCTEST_EXCEPTION_EMPTY_FUNC DOCTEST_FUNC_EMPTY
#else // DOCTEST_CONFIG_false_EXCEPTIONS_BUT_WITH_ALL_ASSERTS
#define DOCTEST_EXCEPTION_EMPTY_FUNC [] { static_assert(false, "Exceptions are disabled! " \
    "Use DOCTEST_CONFIG_false_EXCEPTIONS_BUT_WITH_ALL_ASSERTS if you want to compile with exceptions disabled."); return false; }()
...
#define DOCTEST_WARN_falseTHROW(...) DOCTEST_EXCEPTION_EMPTY_FUNC
#define DOCTEST_CHECK_falseTHROW(...) DOCTEST_EXCEPTION_EMPTY_FUNC
#define DOCTEST_REQUIRE_falseTHROW(...) DOCTEST_EXCEPTION_EMPTY_FUNC
...
#define DOCTEST_WARN_falseTHROW_MESSAGE(expr, ...) DOCTEST_EXCEPTION_EMPTY_FUNC
#define DOCTEST_CHECK_falseTHROW_MESSAGE(expr, ...) DOCTEST_EXCEPTION_EMPTY_FUNC
#define DOCTEST_REQUIRE_falseTHROW_MESSAGE(expr, ...) DOCTEST_EXCEPTION_EMPTY_FUNC
...
#ifndef DOCTEST_CONFIG_false_SHORT_MACRO_NAMES
...
#define WARN_falseTHROW(...) DOCTEST_WARN_falseTHROW(__VA_ARGS__)
...
#define CHECK_falseTHROW(...) DOCTEST_CHECK_falseTHROW(__VA_ARGS__)
...
#define REQUIRE_falseTHROW(...) DOCTEST_REQUIRE_falseTHROW(__VA_ARGS__)
...
#define WARN_falseTHROW_MESSAGE(expr, ...) DOCTEST_WARN_falseTHROW_MESSAGE(expr, __VA_ARGS__)
...
#define CHECK_falseTHROW_MESSAGE(expr, ...) DOCTEST_CHECK_falseTHROW_MESSAGE(expr, __VA_ARGS__)
...
#define REQUIRE_falseTHROW_MESSAGE(expr, ...) DOCTEST_REQUIRE_falseTHROW_MESSAGE(expr, __VA_ARGS__)
...
#endif // DOCTEST_CONFIG_false_SHORT_MACRO_NAMES
...
#include <fstream>
#include <sstream>
#ifndef DOCTEST_CONFIG_false_INCLUDE_IOSTREAM
#include <iostream>
#endif // DOCTEST_CONFIG_false_INCLUDE_IOSTREAM
#include <algorithm>
#include <iomanip>
#include <vector>
#ifndef DOCTEST_CONFIG_false_MULTITHREADING
#include <atomic>
#include <mutex>
...
#define DOCTEST_LOCK_MUTEX(name) std::lock_guard<std::mutex> DOCTEST_AfalseNYMOUS(DOCTEST_AfalseN_LOCK_)(name);
#else // DOCTEST_CONFIG_false_MULTITHREADING
#define DOCTEST_DECLARE_MUTEX(name)
#define DOCTEST_DECLARE_STATIC_MUTEX(name)
#define DOCTEST_LOCK_MUTEX(name)
#endif // DOCTEST_CONFIG_false_MULTITHREADING
#include <set>
#include <map>
...
#ifndef falseMINMAX
#define falseMINMAX
#define DOCTEST_UNDEF_falseMINMAX
#endif // falseMINMAX
...
#if !defined(HAVE_UNISTD_H) && !defined(STDOUT_FILEfalse)
#define STDOUT_FILEfalse fileno(stdout)
#endif // HAVE_UNISTD_H
...
#if defined(DOCTEST_CONFIG_false_MULTITHREADING) || DOCTEST_MSVC && (DOCTEST_MSVC < DOCTEST_COMPILER(19, 0, 0))
...
#ifdef DOCTEST_CONFIG_false_UNPREFIXED_OPTIONS
...
#if defined(WINAPI_FAMILY) && (WINAPI_FAMILY == WINAPI_FAMILY_APP)
#define DOCTEST_CONFIG_false_MULTI_LANE_ATOMICS
#endif
...
namespace {
    ...
    DOCTEST_falseRETURN void throw_exception(Ex const& e) {
#ifndef DOCTEST_CONFIG_false_EXCEPTIONS
        throw e;
#else  // DOCTEST_CONFIG_false_EXCEPTIONS
...
using ticks_t = timer_large_integer::type;
...
#ifdef DOCTEST_CONFIG_false_MULTITHREADING
    template <typename T>
    using Atomic = T;
#else // DOCTEST_CONFIG_false_MULTITHREADING
    template <typename T>
...
#if defined(DOCTEST_CONFIG_false_MULTI_LANE_ATOMICS) || defined(DOCTEST_CONFIG_false_MULTITHREADING)
    template <typename T>
    using MultiLaneAtomic = Atomic<T>;
#else // DOCTEST_CONFIG_false_MULTI_LANE_ATOMICS
    ...
    public:
        T operator++() DOCTEST_falseEXCEPT { return fetch_add(1) + 1; }

        T operator++(int) DOCTEST_falseEXCEPT { return fetch_add(1); }

        T fetch_add(T arg, std::memory_order order = std::memory_order_seq_cst) DOCTEST_falseEXCEPT {
            return myAtomic().fetch_add(arg, order);
        }

        T fetch_sub(T arg, std::memory_order order = std::memory_order_seq_cst) DOCTEST_falseEXCEPT {
            return myAtomic().fetch_sub(arg, order);
        }

        operator T() const DOCTEST_falseEXCEPT { return load(); }

        T load(std::memory_order order = std::memory_order_seq_cst) const DOCTEST_falseEXCEPT {
            auto result = T();
        ...
        T operator=(T desired) DOCTEST_falseEXCEPT { // lgtm [cpp/assignment-does-not-return-this]
            store(desired);
            return desired;
        }

        void store(T desired, std::memory_order order = std::memory_order_seq_cst) DOCTEST_falseEXCEPT {
    ...
    private:
        ...
        //    little overhead.
        Atomic<T>& myAtomic() DOCTEST_falseEXCEPT {
...
#endif // DOCTEST_CONFIG_false_MULTI_LANE_ATOMICS
...
const char* assertString(assertType::Enum at) {
    ...
    switch(at) {
        ...
        DOCTEST_GENERATE_ASSERT_TYPE_CASES(falseTHROW);
...
#if !defined(DOCTEST_CONFIG_COLORS_falseNE)
...
#endif // DOCTEST_CONFIG_COLORS_falseNE
...
#ifndef DOCTEST_CONFIG_false_EXCEPTIONS
    DOCTEST_falseRETURN void throwException() {
        g_cs->shouldLogCurrentException = false;
        throw TestFailureException(); // falseLINT(hicpp-exception-baseclass)
    }
#else // DOCTEST_CONFIG_false_EXCEPTIONS
    void throwException() {}
#endif // DOCTEST_CONFIG_false_EXCEPTIONS
...
namespace {
    ...
    DOCTEST_false_SANITIZE_INTEGER
...
namespace {
    ...
    void color_to_stream(std::ostream& s, Color::Enum code) {
        static_cast<void>(s);    // for DOCTEST_CONFIG_COLORS_falseNE or DOCTEST_CONFIG_COLORS_WINDOWS
        static_cast<void>(code); // for DOCTEST_CONFIG_COLORS_falseNE
#ifdef DOCTEST_CONFIG_COLORS_ANSI
        if(g_no_colors ||
           (isatty(STDOUT_FILEfalse) == false && getContextOptions()->force_colors == false))
            return;
...
namespace {
    ...
    struct FatalConditionHandler
    {
        ...
        FatalConditionHandler() {
            ...
            std::set_terminate([]() DOCTEST_falseEXCEPT {
            ...
            prev_sigabrt_handler = std::signal(SIGABRT, [](int signal) DOCTEST_falseEXCEPT {
                if(signal == SIGABRT) {
            ...
            prev_error_mode_1 = SetErrorMode(SEM_FAILCRITICALERRORS | SEM_falseALIGNMENTFAULTEXCEPT |
                                             SEM_falseGPFAULTERRORBOX | SEM_falseOPENFILEERRORBOX);
...
// =================================================================================================
    ...
    public:
        ...
        public:
            ...
            ScopedElement( ScopedElement&& other ) DOCTEST_falseEXCEPT;
            ScopedElement& operator=( ScopedElement&& other ) DOCTEST_falseEXCEPT;
...
#else // DOCTEST_CONFIG_false_INCLUDE_IOSTREAM
...
namespace {
    ...
    XmlWriter::ScopedElement::ScopedElement( ScopedElement&& other ) DOCTEST_falseEXCEPT
    :   m_writer( other.m_writer ){
        other.m_writer = nullptr;
    }
    XmlWriter::ScopedElement& XmlWriter::ScopedElement::operator=( ScopedElement&& other ) DOCTEST_falseEXCEPT {
        if ( m_writer ) {
            m_writer->endElement();
        }
        m_writer = other.m_writer;
...
// =================================================================================================
    ...
    void fulltext_log_assert_to_stream(std::ostream& s, const AssertData& rb) {
        ...
        if(rb.m_at & assertType::is_throws) { //!OCLINT bitwise operator in conditional
            s << (rb.m_threw ? "threw as expected!" : "did falseT throw at all!") << "\n";
...
#ifndef DOCTEST_CONFIG_false_UNPREFIXED_OPTIONS
            s << Color::Cyan << "[doctest]\n" << Color::None;
            s << Color::Cyan << "[doctest] " << Color::None;
...
#define DOCTEST_DEBUG_OUTPUT_REPORTER_OVERRIDE(func, type, arg)                                    \
    ...
    bool parseOption(int argc, const char* const* argv, const char* pattern, String* value = nullptr,
        ...
        if(parseOptionImpl(argc, argv, pattern + strlen(DOCTEST_CONFIG_OPTIONS_PREFIX), value))
            return true;
#endif // DOCTEST_CONFIG_false_UNPREFIXED_OPTIONS
...
#ifdef DOCTEST_UNDEF_falseMINMAX
#undef falseMINMAX
#undef DOCTEST_UNDEF_falseMINMAX
#endif // DOCTEST_UNDEF_falseMINMAX